...
lyr_BangunanUkur_11.set('fieldAliases', {'id': 'id', 'Bangunan': 'Bangunan', 'Nama': 'Nama', 'km': 'km', 'Debit': 'Debit (lt/dt)', 'B Ambang': 'B Ambang', 'H Air': 'H Air', });
...
lyr_BangunanUkur_11.set('fieldImages', {'id': 'TextEdit', 'Bangunan': 'TextEdit', 'Nama': 'TextEdit', 'km': 'TextEdit', 'Debit': 'TextEdit', 'B Ambang': 'TextEdit', 'H Air': 'TextEdit', });
...
lyr_BangunanUkur_11.set('fieldLabels', {'id': 'hidden field', 'Bangunan': 'inline label - visible with data', 'Nama': 'inline label - visible with data', 'km': 'inline label - visible with data', 'Debit': 'inline label - visible with data', 'B Ambang': 'inline label - visible with data', 'H Air': 'inline label - visible with data', });
