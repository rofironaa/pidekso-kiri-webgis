...
lyr_AreaLayanan_2.set('fieldAliases', {'Id': 'Id', 'AREA_DI': 'Area DI', 'LUAS__HA_': 'Luas (ha)', 'SUMBER_AIR': 'Sumber Air', 'KET__TAMBA': 'Ket Tambahan', 'Area Layan': 'Area Layanan', 'Petak': 'Petak', 'Luas': 'Luas (ha)', 'Q': 'Debit (lt/dt)', 'ambil': 'Pengambilan', 'B Pintu': 'B Pintu', 'H Pintu': 'H Pintu', 'AR': 'AR', 'ARRR': 'ARRR', 'ar_ha': 'ar_ha', });
...
lyr_BangunanCorongan_10.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'id': 'id', 'Bangunan': 'Bangunan', 'Nama': 'Nama', 'km': 'km', 'Q__lt_dt_': 'Debit (lt/dt)', 'Tersier': 'Tersier', 'A__km_': 'Areal (Ha)', 'Debit2': 'Debit (lt/dt)', 'B_Pintu': 'B Pintu (m)', 'h_pintu': 'H Pintu (m)', });
lyr_BangunanUkur_11.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'id': 'id', 'Bangunan': 'Bangunan', 'Nama': 'Nama', 'km': 'km', 'Debit': 'Debit', 'B_Ambang': 'B Ambang', 'H_Air': 'H Air', });
...
lyr_BangunanSadap_13.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'id': 'id', 'Bangunan': 'Bangunan', 'Nama': 'Nama', 'km': 'km', 'Q__lt_dt_': 'Debit (lt/dt)', 'BP_Menerus': 'B Pintu (m)', 'H_Menerus': 'H Pintu (m)', 'Tersier': 'Tersier', 'A__ha_': 'Areal (Ha)', 'Debit_lt': 'Debit (lt/dt)', 'BP_Pengamb': 'B Pintu (m)', 'H_Pengambi': 'H Pintu (m)', 'URL': 'Foto', });
lyr_TitikAcuan_14.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Nama': 'Nama', 'Elevasi': 'Elevasi', 'Keterangan': 'Keterangan', 'X_': 'X', 'Y_': 'Y', });
lyr_AreaLayanan_2.set('fieldImages', {'Id': 'Range', 'AREA_DI': 'TextEdit', 'LUAS__HA_': 'TextEdit', 'SUMBER_AIR': 'TextEdit', 'KET__TAMBA': 'TextEdit', 'Area Layan': 'TextEdit', 'Petak': 'TextEdit', 'Luas': 'TextEdit', 'Q': 'TextEdit', 'ambil': 'TextEdit', 'B Pintu': '', 'H Pintu': '', 'AR': '', 'ARRR': '', 'ar_ha': '', });
...
lyr_SaluranPrimerPideksoKiri_7.set('fieldImages', {'OBJECTID_1': 'TextEdit', 'Tipikal': 'TextEdit', 'Nama': 'TextEdit', 'Panjang': 'TextEdit', 'B': 'TextEdit', 'H': 'TextEdit', 'm': 'TextEdit', 'Ruas (km)': 'TextEdit', 'Patok': 'TextEdit', 'URL': 'ExternalResource', });
...
lyr_BangunanCorongan_10.set('fieldImages', {'OBJECTID': 'TextEdit', 'id': 'TextEdit', 'Bangunan': 'TextEdit', 'Nama': 'TextEdit', 'km': 'TextEdit', 'Q__lt_dt_': 'TextEdit', 'Tersier': 'TextEdit', 'A__km_': 'TextEdit', 'Debit2': 'TextEdit', 'B_Pintu': 'TextEdit', 'h_pintu': 'TextEdit', });
lyr_BangunanUkur_11.set('fieldImages', {'OBJECTID': 'TextEdit', 'id': 'TextEdit', 'Bangunan': 'TextEdit', 'Nama': 'TextEdit', 'km': 'TextEdit', 'Debit': 'TextEdit', 'B_Ambang': 'TextEdit', 'H_Air': 'TextEdit', });
...
lyr_BangunanSadap_13.set('fieldImages', {'OBJECTID': 'TextEdit', 'id': 'TextEdit', 'Bangunan': 'TextEdit', 'Nama': 'TextEdit', 'km': 'TextEdit', 'Q__lt_dt_': 'TextEdit', 'BP_Menerus': 'TextEdit', 'H_Menerus': 'TextEdit', 'Tersier': 'TextEdit', 'A__ha_': 'TextEdit', 'Debit_lt': 'TextEdit', 'BP_Pengamb': 'TextEdit', 'H_Pengambi': 'TextEdit', 'URL': 'ExternalResource', });
...
lyr_BangunanCorongan_10.set('fieldLabels', {'OBJECTID': 'hidden field', 'id': 'hidden field', 'Bangunan': 'inline label - visible with data', 'Nama': 'inline label - visible with data', 'km': 'inline label - visible with data', 'Q__lt_dt_': 'inline label - visible with data', 'Tersier': 'inline label - visible with data', 'A__km_': 'inline label - visible with data', 'Debit2': 'inline label - visible with data', 'B_Pintu': 'inline label - visible with data', 'h_pintu': 'inline label - visible with data', });
lyr_BangunanUkur_11.set('fieldLabels', {'OBJECTID': 'hidden field', 'id': 'hidden field', 'Bangunan': 'inline label - visible with data', 'Nama': 'inline label - visible with data', 'km': 'inline label - visible with data', 'Debit': 'inline label - visible with data', 'B_Ambang': 'inline label - visible with data', 'H_Air': 'inline label - visible with data', });
...
lyr_BangunanSadap_13.set('fieldLabels', {'OBJECTID': 'hidden field', 'id': 'hidden field', 'Bangunan': 'inline label - visible with data', 'Nama': 'inline label - visible with data', 'km': 'inline label - visible with data', 'Q__lt_dt_': 'inline label - visible with data', 'BP_Menerus': 'inline label - visible with data', 'H_Menerus': 'inline label - visible with data', 'Tersier': 'inline label - visible with data', 'A__ha_': 'inline label - visible with data', 'Debit_lt': 'inline label - visible with data', 'BP_Pengamb': 'inline label - visible with data', 'H_Pengambi': 'inline label - visible with data', 'URL': 'inline label - visible with data', });
